...
const config: Config = {
	...
	tagline: 'Make easier and more secure deployments of Hyperledger Fabric on Kubernetes',
		...
		[
			'@docusaurus/preset-classic',
			{
				docs: {
					...
					editUrl: 'https://github.com/hyperledger-bevel/bevel-operator-fabric/edit/master/website/',
				},
				blog: {
					showReadingTime: true,
					// Please change this to your repo.
					editUrl: 'https://github.com/hyperledger-bevel/bevel-operator-fabric/edit/master/website/blog/',
				},
				theme: {
